...
CREATE TABLE IF NOT EXISTS usuarios(
    ...
    apellidos VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Apellido(s) del usuario',
...
CREATE TABLE IF NOT EXISTS app_cobranzas(
    ...
    nombre VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Nombre de cliente',
    ...
    telefono VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Telefono de cliente',
    direccion VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Direccion de cliente',
    correo VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Correo de cliente',
    ...
    latitud VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Longitud coordenada hubicacion',
    longitud VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Latitud coordenada hubicacion',
...
CREATE TABLE IF NOT EXISTS app_clientes(
    ...
    nombre VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Nombre del cliente',
    telefono VARCHAR(1000) NOT NULL DEFAULT '-' COMMENT 'Telefono del cliente',
    fecha_creacion VARCHAR(10) NOT NULL DEFAULT '-' COMMENT 'Fecha de creacion del registro',
    activo BIT NOT NULL DEFAULT 0 COMMENT 'Estatus del registro'
);
